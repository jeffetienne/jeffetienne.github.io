					...
					<div id="main">
						...
						<!-- Intro -->
							<article id="intro">
								...
								<span class="image main"><img src="images/photo.jpg" alt="" /></span>
						...
						<!-- Work -->
							<article id="work">
								...
								<span class="image main">
									<span class="image main"><img src="images/pinball.gif" alt="" /></span>
								</span>
								<ul>
						...
						<!-- Contact -->
							...
							<article id="filex">
								<h2>File Express</h2>
								<hr/>
								<span class="image main"><img src="images/filex.jpg" alt="" /></span>
								<h3>Filex<h3>
								<hr/>
